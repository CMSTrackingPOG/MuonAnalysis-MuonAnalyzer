...
def getOptions():
    ...
    parser.add_option('-w', '--workArea',
                      dest = 'workArea',
                      default = 'CrabLogFiles_Run2022EE_AOD_isOnlySeeded',
    ...
    parser.add_option('-b', '--eraDB',
                      dest = 'eraDB',
                      default = 'MuonAnalysis/MuonAnalyzer/data/samples/muon/Z/Run2022EE/database.json',
...
def main():
    ...
    if crabCmd == 'submit':
        ...
        if storageSite == 'FNAL':
            ...
            config.Data.outLFNDirBase = '/store/user/%s/TnP_ntuples_Run2022EE_AOD_isOnlySeeded/%s/%s/%s/%s' % (getUsername(), particle, resonance, era, dataTier)
