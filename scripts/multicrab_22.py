...
def getOptions():
    ...
    parser.add_option('-w', '--workArea',
                      dest = 'workArea',
                      default= 'CrabLogFiles_Run2022_AOD_AllTracks',
...
def main():
    ...
    if crabCmd == 'submit':
        ...
        if storageSite == 'FNAL':
            ...
            config.Data.outLFNDirBase = '/store/user/%s/TnP_ntuples_Run2022_AOD_AllTracks/%s/%s/%s/%s' % (getUsername(), particle, resonance, era, dataTier)
